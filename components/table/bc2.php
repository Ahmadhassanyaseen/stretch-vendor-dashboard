...
<div class="w-full flex overflow-hidden text-left rounded-lg shadow-xs bg-white dark:bg-gray-800 text-gray-700 dark:text-white xeno-gap">
    <div class="w-full overflow-x-auto bg-white dark:bg-gray-700">
        <table id="loadsTable" class="w-full display">
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="11" class="text-center py-4 text-gray-700 dark:text-gray-400 bg-gray-100 dark:bg-gray-700">No loads found</td>
                </tr>
                <?php } else{ ?>
